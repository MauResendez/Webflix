<?php
    ...
    $preview = new PreviewProvider($con, $userLoggedIn); // shows preview onto page
    echo $preview->createPreviewVideo($entity);

    $seasonProvider = new SeasonProvider($con, $userLoggedIn); // shows seasons and episodes onto page
